...
import static com.wkh.project.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<LoginUserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletResponse response) {
        ...
        LoginUserVO loginUserVO = userService.userLogin(username, userPassword, response);
